...
namespace Combat
{
    ...
    public static class StrategicDispatchService
    {
        ...
        /// them along <paramref name="waypoints"/>. The first soldier to arrive
        /// triggers a capture attempt on <paramref name="targetPlotId"/>.
        /// Returns the number of soldiers dispatched.
        /// </summary>
            ...
            float gatherRadius = 5f)
        {
            ...
            foreach (var u in GameObject.FindObjectsByType<UnitCombat>(FindObjectsSortMode.None))
            {
                ...
                // One-shot handler: cleans itself up and triggers capture
